 ...
 * HelloController 클래스는 지금부터 Request Router
 * Spring 에서는 Router 를 Controller 라고 한다.
 * MVC 패턴에서
 * Client 의 Request 를 제일 먼저 수신하는 클래스 파일
 */
...
public class HelloController {
	...
	public String hello() {
		/**
		 * /WEB-INF/views/hello.jsp 파일을 Rendering 하여 응답하라
		 */
		return "hello";
	}
	
	/**
	 * Client 로부터 http://localhost:8080/hello/nation 이라는 요청이 오면
	...
	/**
	 * Client 로부터 http://localhost:8080/hello/ 라는 요청이 오면
	 *  /WEB-INT/views/home.jsp 파일을 Rendering 라여 응답하라
	 */
